...
from ..common import shift_t
from ..draw import draw_line

from .common import convert_speed
...
class Lane:
  ...
  def generate_boundary(self, left_boundary, start_s):
    ...
    for point3d in left_boundary:
      ...
      self.center_line.append((cpoint3d, width))
    ...
    if not debug_mode:
      if self.lane_type == "driving":
        ...
        draw_line(self.left_boundary,'y')
        draw_line(self.right_boundary,'b')
    return self.right_boundary
    '''
