...
def _message(
    widget: QWidget, title: str, text: str, buttons=QMessageBox.Ok, default_button=QMessageBox.Ok
...
def error(
    widget: QWidget, text: str, buttons=QMessageBox.Ok, default_button=QMessageBox.Ok
) -> QMessageBox.StandardButton:
