...
from crdesigner.ui.gui.mwindow.service_layer.gui_resources.osm_settings_ui import Ui_OSMSettings as Settings_window
from crdesigner.ui.gui.mwindow.service_layer.osm_settings_ui import (
    Street_types,
    Lane_counts,
    Lane_width,
    Sublayer_street_types,
)
...
class EditStreetTypes:
    ...
    def __init__(self, mwindow):
        ...
        self.dialog.setStyleSheet(
            "background-color:"
            + mwindow.colorscheme().background
            + "; color:"
            + mwindow.colorscheme().color
            + ";font-size: "
            + mwindow.colorscheme().font_size
        )
        self.dialog.exec_()
    ...
    def save(self) -> None:
        ...
        config.ACCEPTED_HIGHWAYS_MAINLAYER = [
            current_type for check_box, current_type in types.items() if check_box.isChecked()
        ]
