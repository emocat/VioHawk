...
def set_draw_params(
    ...
    obstacle_label: bool,
    obstacle_icon: bool,
    obstacle_direction: bool,
    obstacle_signal: bool,
    occupancy: bool,
    traffic_signs: bool,
    traffic_lights: bool,
    incoming_lanelets: bool,
    successors: bool,
    ...
    PARAMS_DRAW_CUSTOM = DrawParamsCustom(
    ...
    PARAMS_DRAW_DYNAMIC_CUSTOM = DrawParamsCustom(
        color_schema=colorscheme,
...
PARAMS_DRAW_DETAILED = DrawParamsCustom(
    dynamic_obstacle=DynamicObstacleParams(trajectory=TrajectoryParams(draw_trajectory=False), show_label=True),
    lanelet_network=LaneletNetworkParams(
        lanelet=LaneletParams(
            draw_start_and_direction=False,
            draw_stop_line=False,
...
PARAMS_DRAW_UNDETAILED = DrawParamsCustom(
    lanelet_network=LaneletNetworkParams(
        lanelet=LaneletParams(
            draw_start_and_direction=False,
            draw_stop_line=False,
...
PARAMS_DRAW_DYNAMIC_DETAILED = DrawParamsCustom(
    dynamic_obstacle=DynamicObstacleParams(trajectory=TrajectoryParams(draw_trajectory=False), show_label=True),
    lanelet_network=LaneletNetworkParams(
        lanelet=LaneletParams(
            draw_start_and_direction=False,
...
PARAMS_DRAW_DYNAMIC_UNDETAILED = DrawParamsCustom(
    dynamic_obstacle=DynamicObstacleParams(trajectory=TrajectoryParams(draw_trajectory=False)),
    lanelet_network=LaneletNetworkParams(
        lanelet=LaneletParams(
            draw_start_and_direction=False,
            draw_stop_line=False,
