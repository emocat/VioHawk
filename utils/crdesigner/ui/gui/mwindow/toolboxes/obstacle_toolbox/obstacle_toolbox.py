...
class ObstacleToolbox(QDockWidget):
        ...
        if self.obstacle_toolbox_ui.default_color.isChecked():
            ...
            if self.obstacle_color is not None and not self.obstacle_toolbox_ui.change_color:
                ...
                self.canvas.set_static_obstacle_color(
                    static_obstacle.obstacle_id, self.obstacle_toolbox_ui.obstacle_color.name()
                )
        self.obstacle_color = None
    ...
    def dynamic_obstacle_details(self, obstacle_id: int):
        ...
        if self.obstacle_toolbox_ui.default_color.isChecked():
            ...
            if self.obstacle_color is not None and not self.obstacle_toolbox_ui.change_color:
                self.canvas.set_dynamic_obstacle_color(dynamic_obstacle.obstacle_id, self.obstacle_color)
            else:
                self.canvas.set_dynamic_obstacle_color(
                    dynamic_obstacle.obstacle_id, self.obstacle_toolbox_ui.obstacle_color.name()
                )
        self.obstacle_color = None
    ...
    def clear_obstacle_fields(self):
        ...
        if (
            self.obstacle_toolbox_ui.obstacle_dyn_stat.currentText() == "Static"
            and self.obstacle_toolbox_ui.obstacle_shape.currentText() != "Polygon"
        ):
            self.obstacle_toolbox_ui.obstacle_x_Position.setText("")
            self.obstacle_toolbox_ui.obstacle_y_Position.setText("")
