...
class SectionExpandButton(QPushButton):
    ...
    def update_window(self):
        self.setStyleSheet(
            "background-color:"
            + self.mwindow.colorscheme().highlight
            + "; color:"
            + self.mwindow.colorscheme().highlight_text
            + "; font-size:"
...
class PositionButton(QPushButton):
    ...
    def update_window(self):
        if self.button_pressed:
            self.setStyleSheet(
                "color: "
                + self.toolbox.mwindow.colorscheme().highlight_text
                + "; background-color: "
                + self.toolbox.mwindow.colorscheme().highlight
            )
            self.setIcon(QIcon(":/icons/target.png"))
        else:
            self.setStyleSheet(
                ...
                + self.toolbox.mwindow.colorscheme().highlight
                + "; background-color: "
                + self.toolbox.mwindow.colorscheme().second_background
            )
            if config.DARKMODE:
