...
from crdesigner.ui.gui.mwindow.toolboxes.toolbox_ui import (
    Toolbox,
    CheckableComboBox,
    CollapsibleArrowBox,
    CollapsibleCheckBox,
...
class RoadNetworkToolboxUI(Toolbox):
    ...
    def update_length(self):
        ...
        if self.select_end_position.isChecked():
            ...
            if self.end_position_y_changed:
                ...
                return
            pos = [
                self.lanelet_start_position_x.text(),
                self.lanelet_start_position_y.text(),
                self.lanelet_end_position_x.text(),
                self.lanelet_end_position_y.text(),
            ]
            if any("" == v for v in pos) or any("-" == v for v in pos):
                return
            x = float(self.lanelet_start_position_x.text().replace(",", ".")) - float(
                self.lanelet_end_position_x.text().replace(",", ".")
            )
            y = float(self.lanelet_start_position_y.text().replace(",", ".")) - float(
                self.lanelet_end_position_y.text().replace(",", ".")
            )
    ...
    def update_selected_length(self):
        ...
        if self.selected_end_position_y_changed:
            ...
            return
        pos = [
            self.selected_lanelet_start_position_x.text(),
            self.selected_lanelet_start_position_y.text(),
            self.selected_lanelet_end_position_x.text(),
            self.selected_lanelet_end_position_y.text(),
        ]
        if any("" == v for v in pos) or any("-" == v for v in pos):
            return
        x = float(self.selected_lanelet_start_position_x.text().replace(",", ".")) - float(
            self.selected_lanelet_end_position_x.text().replace(",", ".")
        )
        y = float(self.selected_lanelet_start_position_y.text().replace(",", ".")) - float(
            self.selected_lanelet_end_position_y.text().replace(",", ".")
        )
    ...
    def add_curved_fields(self, index):
        ...
        self.curved_check_button = CollapsibleCheckBox(
            "Curved Lanelet", layout_curved_box, self.layout_lanelet_adding_groupbox, index
        )
        if self.place_at_position.isChecked():
    ...
    def add_line_marking_fields(self, index):
        ...
        self.line_marking_box = CollapsibleArrowBox(
            "Line marking", layout_line_marking, self.layout_lanelet_adding_groupbox, index, self.mwindow, self
        )
    ...
    def add_neighboring_lanelets_fields(self, index):
        ...
        self.neighboring_lanelets_button = CollapsibleArrowBox(
            "Neighboring Lanelets",
            layout_neighboring_lanelets,
            self.layout_lanelet_adding_groupbox,
            index,
            self.mwindow,
            self,
        )
    ...
    def add_advanced_fields(self, index):
        ...
        self.advanced_button = CollapsibleArrowBox(
            "Advanced", layout_advanced, self.layout_lanelet_adding_groupbox, index, self.mwindow, self
        )
    ...
    def init_connect_to_previous_added_fields(self):
        ...
        self.lanelet_width.setStyleSheet(
            "background-color: "
            + self.mwindow.colorscheme().second_background
            + "; color: "
    ...
    def add_attribute_fields(self):
        ...
        self.selected_button_start_position = PositionButton(
            self.selected_lanelet_start_position_x, self.selected_lanelet_start_position_y, self
        )
        ...
        self.selected_button_end_position = PositionButton(
            self.selected_lanelet_end_position_x, self.selected_lanelet_end_position_y, self
        )
        ...
        self.attributes_button = CollapsibleArrowBox(
            "Lanelet Attributes", layout_attributes, self.layout_lanelet_attributes_groupbox, 3, self.mwindow, self
        )
    ...
    def add_selected_line_markings(self, layout_attributes):
        ...
        self.line_marking_box = CollapsibleArrowBox(
            "Line marking", layout_line_marking, layout_attributes, 6, self.mwindow, self
        )
    ...
    def adjust_selected_stop_line_position(self):
        ...
        if self.selected_stop_line_select_position.isChecked():
            ...
            self.button_selected_stop_line_start_position = PositionButton(
                self.selected_stop_line_start_x, self.selected_stop_line_start_y, self
            )
            self.button_selected_stop_line_end_position = PositionButton(
                self.selected_stop_line_end_x, self.selected_stop_line_end_y, self
            )
            ...
            self.selected_lanelet_select_stop_line_position.addWidget(
                self.button_selected_stop_line_start_position, 1, 7
            )
    ...
    def add_selected_neighboring_fields(self, layout_attributes):
        ...
        self.selected_neighboring_lanelets_button = CollapsibleArrowBox(
            "Neighboring Lanelets", layout_neighboring_lanelets, layout_attributes, 8, self.mwindow, self
        )
    ...
    def add_selected_advanced_fields(self, layout_attributes):
        ...
        self.advanced_button = CollapsibleArrowBox(
            "Advanced", layout_advanced, layout_attributes, 10, self.mwindow, self
        )
    ...
    def create_traffic_light_widget(self):
        ...
        button_traffic_light_position = PositionButton(
            self.x_position_traffic_light, self.y_position_traffic_light, self
        )
