...
class TopBarWrapper:
    ...
    def __init__(self, mwindow):
        ...
        self.menu_bar_wrapper = MenuBarWrapper(
            mwindow=self.mwindow,
            file_new=file_new,
            open_commonroad_file=open_commonroad_file,
            close_window=close_window,
            show_settings=show_settings,
            open_cr_web=open_cr_web,
            open_cr_forum=open_cr_forum,
            file_save=file_save,
        )
        self.toolbar_wrapper = ToolBarWrapper(
            mwindow=self.mwindow, file_new=file_new, open_commonroad_file=open_commonroad_file, file_save=file_save
        )
