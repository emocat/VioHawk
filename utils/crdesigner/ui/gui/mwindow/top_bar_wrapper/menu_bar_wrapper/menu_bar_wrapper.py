...
class MenuBarWrapper:
    ...
    def __init__(
        ...
        self.separator.setSeparator(True)
        # exit action
        self.exit_action = create_action(
            mwindow=mwindow,
            text="Quit",
            icon=QIcon(":/icons/close.png"),
            checkable=False,
            slot=lambda: close_window(mwindow),
            tip="Quit",
        ...
        self.open_web_action = create_action(
            mwindow=mwindow,
            text="Open CR Web",
            icon="",
            checkable=False,
        ...
        self.open_forum_action = create_action(
            mwindow=mwindow,
            text="Open Forum",
            icon="",
            checkable=False,
