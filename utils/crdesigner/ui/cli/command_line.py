...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        const="all",
        nargs="?",
        choices=["gui", "map-convert-osm", "map-convert-sumo", "map-convert-lanelet", "map-convert-opendrive"],
        help="specification of operation mode",
        default="gui",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="indicator whether a conversion from CommonRoad to the other format should be performed, " "default=False",
    )
    parser.add_argument(
        "-f",
        "--force-overwrite",
    ...
    parser.add_argument(
        "--left-driving",
        action="store_true",
        help="set to true if map describes a left driving "
    ...
    parser.add_argument(
        "--affiliation", help="your affiliation, e.g., university, research institute, company", default=""
    )
