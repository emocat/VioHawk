...
class ConversionLanelet(Lanelet):
    ...
    def __init__(
        ...
        traffic_signs=None,
        traffic_lights=None,
        custom_default_lanelet_types=CustomDefaultLaneletType(
            config.opendrive.general_lanelet_type_activ,
        ...
        self._default_lanelet_type = (
            {
                ...
                if LaneletType(custom_default_lanelet_types.general_lanelet_type) is not None
                else LaneletType.UNKNOWN
            }
            if custom_default_lanelet_types.general_lanelet_type_activ
            else set()
        )
        self._driving_default_lanelet_type = (
            LaneletType(custom_default_lanelet_types.driving_default_lanelet_type)
