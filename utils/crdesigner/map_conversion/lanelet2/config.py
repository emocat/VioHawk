...
"""
from commonroad.scenario.traffic_sign import TrafficSignIDGermany, TrafficSignIDZamunda, TrafficSignIDUsa  # type: ignore
...
CR2LANELET_SUPPORTED_COUNTRIES_PREFIX_DICTIONARY = {
